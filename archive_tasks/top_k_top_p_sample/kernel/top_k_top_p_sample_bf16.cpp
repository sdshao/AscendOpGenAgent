...
extern "C" __global__ __aicore__ void top_k_top_p_sample_bf16_custom(
    GM_ADDR logits,
    GM_ADDR topKs,
    GM_ADDR topPs,
    GM_ADDR q,
    ...
    GM_ADDR tiling)
{
    ...
    TopKTopPSampleKernel<bfloat16_t> kernel;
...
extern "C" void top_k_top_p_sample_do_bf16(
    uint32_t blockDim,
    void *stream,
    uint8_t *logits,
    uint8_t *topKs,
    ...
    uint8_t *tiling)
{
    top_k_top_p_sample_bf16_custom<<<blockDim, nullptr, stream>>>(
        logits,
        topKs,
        topPs,
        q,
